...
const app = express()
const { getAllTopics, getJSONctrl, getAllArticles, getArticleById,  getAllCommentsByArtId, postComment, getPatchedArticleById  } = require('./controllers/controllers.js');
